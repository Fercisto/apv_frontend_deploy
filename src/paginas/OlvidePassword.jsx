    ...
    <>
        ...
        <div className='mt-20 md:mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
            ...
            <form className="mt-5 space-y-5" onSubmit={handleSubmit}>
                ...
                <input type="submit" value="Enviar Instrucciones" className="bg-indigo-700 w-full md:w-auto py-3 px-10 rounded-xl text-white uppercase font-bold hover:cursor-pointer hover:bg-indigo-800 transition-colors" />
